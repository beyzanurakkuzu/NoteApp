package com.beyzaakkuzu.noteapp.feature.presentation.notes.components
...
@Composable
fun NoteItem(
    modifier: Modifier = Modifier, note: Note, cornerRadius: Dp = 10.dp,
    ...
    Box(modifier = Modifier) {
        Canvas(modifier = Modifier.matchParentSize()) {
            ...
            clipPath(clipPath) { //drawscope
                drawRoundRect(
                    color = Color(note.color), size = size,
